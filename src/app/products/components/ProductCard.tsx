...
function ProductCard({
	...
	return (
		<Link
			href={'/productos/' + _id}
			className="flex flex-col relative w-48 h-48 xl:w-60 xl:h-60 cursor-pointer drop-shadow overflow-hidden transition-transform hover:scale-105 group bg-zinc-900 rounded-md">
			{picture?.length > 0 ? (
				<Image
