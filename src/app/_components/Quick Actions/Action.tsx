...
function Action({
	...
	return (
		<Link
			href={action.href}
			key={action.id}
			className="flex flex-col items-center justify-center basis-2/3 aspect-square max-w-xs shrink-0 text-sm font-bold bg-zinc-200 rounded-md text-zinc-950 active:text-rose-50">
