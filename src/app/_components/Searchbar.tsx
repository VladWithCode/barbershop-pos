...
export default function Searchbar({
	...
	return (
		<div className="flex items-center h-10">
			...
			/>
			<div className="flex items-center justify-center h-full w-1/12 border-2 border-transparent -ml-1 peer-focus:bg-zinc-800 peer-focus:border-zinc-50 peer-focus:text-zinc-50 rounded-e cursor-pointer">
