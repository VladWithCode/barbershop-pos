...
function Option({
	...
	return (
		<Link
			href={option.href}
			key={option.id}
			className="flex flex-col items-center justify-center basis-2/3 aspect-square max-w-xs shrink-0 text-sm font-bold text-zinc-800 bg-zinc-300 rounded p-4 hover:bg-zinc-200">
