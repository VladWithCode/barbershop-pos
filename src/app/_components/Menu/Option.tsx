...
function Option({
	...
	return (
		<Link
			href={option.href}
			key={option.id}
			className="flex flex-col items-center justify-center basis-2/3 aspect-square max-w-xs shrink-0 text-sm font-bold text-zinc-950 bg-zinc-50 rounded-md active:text-rose-50">
